...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("vanshsuri75gmail.com");
            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">I specalize in JavaScript with a focus on React ecosystem.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid-container">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">vanshsuri75@gmail.com</p>
                        </div>
